export class Parent_ext {
  ...
  private readonly _birthdayParent: string = '';
  ...
  constructor(idParent: number, loginParent: string, passwordParent: string, nameParent: string,
              surnameParent: string, birthdayParent: string, emailParent: string, phoneParent: string) {
  ...
  public get birthdayParent(): string {
