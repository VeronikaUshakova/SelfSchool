export class Teacher_ext {
  ...
  private readonly _birthdayTeacher: string = '';
  ...
  constructor(idTeacher: number, loginTeacher: string, passwordTeacher: string, nameTeacher: string,
              surnameTeacher: string, birthdayTeacher: string, emailTeacher: string, phoneTeacher: string,
  ...
  public get birthdayTeacher(): string {
